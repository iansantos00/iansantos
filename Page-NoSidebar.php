...
get_header(); ?>
	 ...
	 <div class="wrapper">
        <div class="header header-filter" style="background-image: url('http://localhost/wordpress/wp-content/uploads/2016/05/computer-1328422_1920.jpg');">
            <div class="container">
                <div class="row">
					<div class="col-sm-12">
						<h1 class="title">Desenvolvendo sites do seu jeito.</h1>
	                    <h4>
